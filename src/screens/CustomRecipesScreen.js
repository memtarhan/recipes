...
export default function CustomRecipesScreen() {
    ...
    // Defensive: fallback to empty object if params missing
    const { recipe } = route.params || {};
    // Remove or comment out excessive logs
    // console.log('recipe',recipe);

    // Defensive: ensure favoriteRecipe is always an array
    ...
    // Defensive: check recipe and favoriteRecipe before using
    const isFavourite = recipe && Array.isArray(favoriteRecipe)
