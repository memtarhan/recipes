            ...
            <View style={styles.contentContainer}>
                ...
                <View style={styles.miscContainer} testID="miscContainer">
                    <View style={styles.miscItem}>
                        <Text style={styles.miscText}>Servings: {recipe.servings || "N/A"}</Text>
                    </View>
                    <View style={styles.miscItem}>
                        <Text style={styles.miscText}>Calories: {recipe.calories || "N/A"}</Text>
                    </View>
                </View>
            </View>
                ...
                <View style={styles.ingredientsList}>
                    {recipe.ingredients?.map((ing, idx) => (
                        <View key={idx} style={styles.ingredientItem}>
                            ...
                            <Text style={styles.ingredientText}>{ing.ingredientName} - {ing.measure}</Text>
                        </View>
                    ))}
                </View>
            </View>
